...
import cn.guet.service.impl.ProductServiceImpl;
...
public class ProductController  {
	...
	public void addProduct(HttpServletRequest request, HttpServletResponse response) {
		...
		/*realPath:D:/ideaProjectOut/upload*/
		//String realPath = this.addProduct.getRealPath("/upload");
		//存放路径
	...
	@RequestMapping("/showOtherproduct")
